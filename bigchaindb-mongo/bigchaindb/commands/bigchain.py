...
def main():
    ...
    '''
    #Questa sezione riguarda l'avviamento da riga di comando di un sottoprocesso che avvia
    #una connessione con il rethinkdb; non essendo interessati a rethink chiudo questa possibilità        
