...
'''
#Come questa è la funzione richiamata nel caso venisse confermato il comando relativo a rethink
#che ne avvia il processo figlio; non essendo interessati a rethink blocco questo codice
def start_rethinkdb():
...
base_parser = argparse.ArgumentParser(add_help=False, prog='bigmongodb')
