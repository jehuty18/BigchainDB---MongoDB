...
class Voter(object):
    ...
    def validate(self):
        ...
        while True:
            ...
            self.v_previous_block_id.value = new_block['_id'].encode()
    ...
    def update_block(self):
        ...
        while True:
            ...
            logger.info('updating block %s with number %s and with vote %s', block['_id'], block_number, vote)
    ...
    def bootstrap(self):
        ...
        self.v_previous_block_id.value = last_voted['_id'].encode()
